...
const EVAN_SUCK_ANIMATION = preload("res://old/instances/player/animations/evan_suck_animation.tscn")
...
func start_underworld_initial_intro() -> void:
	AmbientAudioManager.call_deferred("play_track", "res://old/assets/sfx/ambience/underground_creek.mp3") # calls at the end of frame 
	...
	MusicManager.play_track("res://old/assets/music/3-Chimes_loop.mp3")
